...
const MAKER_EXAMPLES = [
  ...
  { src: "/examples/brat-maker-ex-5-v5.png", alt: "meme-style brat text card reading unbothered" },
  { src: "/examples/brat-maker-ex-6-v5.png", alt: "high-contrast brat design with custom hex colors" },
];

const FONT_EXAMPLES = [
  { src: "/examples/brat-font-ex-1-v5.png", alt: "brat font style preview with wide spacing" },
  { src: "/examples/brat-font-ex-2-v5.png", alt: "tight letter spacing example in brat style text" },
  { src: "/examples/brat-font-ex-3-v5.png", alt: "heavy sans-serif brat text sample" },
  { src: "/examples/brat-font-ex-4-v5.png", alt: "minimal typography layout with centered brat text" },
  { src: "/examples/brat-font-ex-5-v5.png", alt: "custom brat font settings preview" },
  { src: "/examples/brat-font-ex-6-v5.png", alt: "high-contrast typographic brat text design" },
];
