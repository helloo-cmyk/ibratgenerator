...
export const metadata = {
  ...
  description:
    "The Brat Name Generator is a simple tool that helps you create unique, Brat-style names instantly. It's designed for users who want short, bold, aesthetic names inspired by the Brat era and Charli XCX's visual and musical identity.",
};
    ...
    <main className="space-y-10">
      ...
      <section>
        <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-14 text-base leading-relaxed text-foreground/90">
          ...
          <p className="mb-4">
            Use the <Link href="/brat-maker/" className="text-primary underline hover:no-underline">brat maker</Link> to create custom brat-style visuals. Create brat graphics with the <Link href="/brat-creator/" className="text-primary underline hover:no-underline">Brat Creator</Link>, use the <Link href="/brat-text-generator/" className="text-primary underline hover:no-underline">brat text generator</Link> to generate brat text, design with the <Link href="/brat-font-generator/" className="text-primary underline hover:no-underline">brat font tool</Link>, make cover art with the <Link href="/brat-album-cover-generator/" className="text-primary underline hover:no-underline">brat album maker</Link>, or try the <Link href="/brat-summer-meme-generator/" className="text-primary underline hover:no-underline">Brat Summer Meme Generator</Link> for memes.
          </p>
        </div>
      </section>
