    ...
    <main className="space-y-10">
      <section>
        <div className="text-center">
          <div className="mx-auto max-w-2xl px-4 py-10 sm:px-6 sm:py-14 text-base leading-relaxed text-foreground/90">
            <h1 className="text-4xl sm:text-5xl font-semibold tracking-tight text-foreground mt-6 mb-3 mx-auto">About Ibrat Generator</h1>
            <p className="mb-5">
      ...
      <section>
        <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-14 text-base leading-relaxed text-foreground/90">
          <h2 className="text-2xl sm:text-3xl font-semibold tracking-tight text-foreground">Our Mission</h2>
          <p className="mb-4">
      ...
      <section>
        <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-14 text-base leading-relaxed text-foreground/90">
          <h2 className="text-2xl sm:text-3xl font-semibold tracking-tight text-foreground">What You Can Create With Ibrat Generator</h2>
          <p className="mb-4">
      ...
      <section>
        <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-14 text-base leading-relaxed text-foreground/90">
          <h2 className="text-2xl sm:text-3xl font-semibold tracking-tight text-foreground">Why We Built This Tool</h2>
          <p className="mb-4">
      ...
      <section>
        <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-14 text-base leading-relaxed text-foreground/90">
          <h2 className="text-2xl sm:text-3xl font-semibold tracking-tight text-foreground">Key Features</h2>
          <p className="mb-4">
          ...
          <ul className="mb-4 list-inside list-disc space-y-1">
            ...
            <li>Real-time results — see your text come alive as you type. A live canvas preview updates as you change text, colors, or layout.</li>
            <li>Customizable fonts — choose from several Brat-style fonts and adjust size, spacing, and alignment.</li>
            <li>Color presets — switch between classic looks like neon green, black, pink, or white with one click, or pick your own colors.</li>
            <li>Stickers and decorations — add emojis and stickers to your design, then drag, resize, and rotate them on the canvas.</li>
            <li>Instant PNG export — download your design in high resolution (up to 3000 px) with no watermark.</li>
            <li>Custom ratios for social media — square, 4:5 for Instagram, 9:16 for stories and reels, or 16:9 for wide formats.</li>
            <li>Mobile-friendly design — the editor works on phones and tablets so you can create on the go.</li>
          </ul>
          <p>
      ...
      <section>
        <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-14 text-base leading-relaxed text-foreground/90">
          <h2 className="text-2xl sm:text-3xl font-semibold tracking-tight text-foreground">Who Uses This Tool</h2>
          <p className="mb-4">
          ...
          <ul className="mb-4 list-inside list-disc space-y-1">
            ...
            <li>Content creators who need fast graphics for TikTok, Instagram, or blogs</li>
            <li>Charli XCX fans and anyone who likes the Brat aesthetic</li>
            <li>Anyone looking to make visually striking text graphics without a learning curve</li>
          </ul>
          <p>
      ...
      <section>
        <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-14 text-base leading-relaxed text-foreground/90">
          <h2 className="text-2xl sm:text-3xl font-semibold tracking-tight text-foreground">Commitment to Free Online Tools</h2>
          <p className="mb-4">
      ...
      <section>
        <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-14 text-base leading-relaxed text-foreground/90">
          <h2 className="text-2xl sm:text-3xl font-semibold tracking-tight text-foreground">Future Improvements</h2>
          <p className="mb-4">
