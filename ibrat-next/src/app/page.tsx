...
export const metadata = {
  ...
  description:
    "Free brat generator and brat simulator - type your text, pick your color, download a clean PNG in seconds. No signup, no watermark. Works on mobile.",
  alternates: {
    ...
    <div className="hp-root">
      ...
      <section className="hp-hero">
        ...
        <p className="hp-hero-sub">
          Create brat-style images, memes, and profile pictures with this free brat image generator online. Also known as a brat simulator - type any text and watch it transform into the brat aesthetic instantly. Pick colors, add stickers, and download a high-res PNG. No signup. No watermark. Inspired by the Charli XCX brat aesthetic.
        </p>
      </section>
      ...
      {/* ── SECTION 1: WHY YOUR BRAT IMAGE LOOKS WRONG ── */}
      <section className="bg-zinc-50 py-24 px-4 overflow-hidden border-b-2 border-black/5">
        <div className="max-w-[1200px] mx-auto flex gap-12 group">
          <div className="w-12 flex-shrink-0 flex items-start pt-2 hidden md:block">
            <span className="text-[12px] font-black uppercase tracking-[0.5em] [writing-mode:vertical-lr] rotate-180 opacity-50 group-hover:opacity-100 transition-all">Mistakes</span>
          </div>
          <div className="flex-1">
            <h2 className="text-4xl sm:text-7xl font-black italic uppercase tracking-tighter mb-12 leading-none">Why Your Brat Image Looks Wrong</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="space-y-8">
                <div>
                  <h3 className="text-2xl font-black italic uppercase tracking-tighter mb-3 border-l-4 border-[#89CC04] pl-6">Wrong Green Color</h3>
                  <p className="hp-body-text text-[17px] opacity-80 leading-relaxed m-0">Most tools use #c1ff00 or lime green which completely changes the vibe. The real brat green is #89CC04 - darker, slightly more olive, and much more grounded. This tool uses the correct hex code automatically so you never have to guess.</p>
                </div>
                <div>
                  <h3 className="text-2xl font-black italic uppercase tracking-tighter mb-3 border-l-4 border-black pl-6">Text Too Sharp</h3>
                  <p className="hp-body-text text-[17px] opacity-80 leading-relaxed m-0">The original album cover has slightly blurred text - not crisp, perfect digital type. Using standard sharp fonts ruins the effect. Use the Softness slider (1-1.5px) for an authentic, slightly messy look.</p>
                </div>
              </div>
              <div className="space-y-8">
                <div>
                  <h3 className="text-2xl font-black italic uppercase tracking-tighter mb-3 border-l-4 border-black/20 pl-6">Too Many Words</h3>
                  <p className="hp-body-text text-[17px] opacity-80 leading-relaxed m-0">Brat text works with 1 to 4 words maximum. More than that and the aesthetic completely breaks down because the typography loses its visual weight. Short and punchy always beats long and descriptive sentences.</p>
                </div>
                <div>
                  <h3 className="text-2xl font-black italic uppercase tracking-tighter mb-3 border-l-4 border-[#89CC04] pl-6">Wrong Aspect Ratio</h3>
                  <p className="hp-body-text text-[17px] opacity-80 leading-relaxed m-0">Make sure to use Square (1:1) for profile pictures so it fits the crop perfectly. Choose 9:16 for TikTok and Instagram stories to fill the whole screen. Use 16:9 for Twitter headers and YouTube thumbnails. This generator has all four presets built right in.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* ── SECTION 2: POPULAR BRAT STYLES ── */}
      <section className="bg-white py-24 px-4 overflow-hidden border-b-2 border-black/5">
        <div className="max-w-[1200px] mx-auto flex gap-12 group">
          <div className="w-12 flex-shrink-0 flex items-start pt-2 hidden md:block">
            <span className="text-[12px] font-black uppercase tracking-[0.5em] [writing-mode:vertical-lr] rotate-180 opacity-50 group-hover:opacity-100 transition-all">Styles</span>
          </div>
          <div className="flex-1">
            <h2 className="text-4xl sm:text-7xl font-black italic uppercase tracking-tighter mb-8 leading-none">Popular Brat Styles to Try</h2>
            <p className="hp-body-text mb-12 text-[17px] sm:text-[18px] opacity-80 leading-relaxed max-w-3xl">
              There is a lot more to the format than just the standard green. Creative users are constantly remixing the core aesthetic across different colors and layouts to match their personal brand and specific content needs. Whether you want something moody, high-contrast, or minimal, the core formula stays the same. Here are six styles you can recreate instantly by adjusting color and text.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              <div className="bg-[#89CC04] p-8 border-4 border-black group/card">
                <h3 className="text-xl font-black italic uppercase tracking-tighter mb-4 text-black">Classic Brat</h3>
                <p className="text-sm font-bold opacity-70 mb-4 text-black">Background: #89CC04 | Text: your name or &quot;brat&quot;</p>
                <p className="text-[15px] opacity-90 leading-relaxed m-0 text-black">The original look - green background, bold lowercase text. The most recognizable style.</p>
              </div>
              <div className="bg-[#0a0a0a] p-8 border-4 border-black group/card">
                <h3 className="text-xl font-black italic uppercase tracking-tighter mb-4 !text-white">Dark Mode Brat</h3>
                <p className="text-sm font-bold opacity-70 mb-4 !text-white">Background: #0a0a0a | Text: &quot;whatever&quot;</p>
                <p className="text-[15px] opacity-90 leading-relaxed m-0 !text-white">Black background, white text. Sharper, moodier, works better for edgy content.</p>
              </div>
              <div className="bg-[#ff90e8] p-8 border-4 border-black group/card">
                <h3 className="text-xl font-black italic uppercase tracking-tighter mb-4 text-black">Pink Brat</h3>
                <p className="text-sm font-bold opacity-70 mb-4 text-black">Background: #ff90e8 | Text: &quot;not my problem&quot;</p>
                <p className="text-[15px] opacity-90 leading-relaxed m-0 text-black">Softer and more playful. Popular on Instagram and for lifestyle content.</p>
              </div>
              <div className="bg-[#ffffff] p-8 border-4 border-black group/card">
                <h3 className="text-xl font-black italic uppercase tracking-tighter mb-4 text-black">Clean Brat</h3>
                <p className="text-sm font-bold opacity-70 mb-4 text-black">Background: #ffffff | Text: &quot;clean&quot;</p>
                <p className="text-[15px] opacity-90 leading-relaxed m-0 text-black">White background, minimal look. Closest to &quot;clean girl&quot; but with brat energy.</p>
              </div>
              <div className="bg-[#89CC04] p-8 border-4 border-black group/card">
                <h3 className="text-xl font-black italic uppercase tracking-tighter mb-4 text-black">Reaction Brat</h3>
                <p className="text-sm font-bold opacity-70 mb-4 text-black">Background: #89CC04 | Text: &quot;i said what i said&quot;</p>
                <p className="text-[15px] opacity-90 leading-relaxed m-0 text-black">Two-line text for reaction memes and Twitter/X posts.</p>
              </div>
              <div className="bg-[#0a0a0a] p-8 border-4 border-black group/card">
                <h3 className="text-xl font-black italic uppercase tracking-tighter mb-4 !text-white">Wallpaper Brat</h3>
                <p className="text-sm font-bold opacity-70 mb-4 !text-white">Background: #0a0a0a | Text: &quot;2026&quot;</p>
                <p className="text-[15px] opacity-90 leading-relaxed m-0 !text-white">9:16 format, single word or year. Made for phone lock screens.</p>
              </div>
            </div>
            <div className="flex flex-col sm:flex-row gap-6">
              <Link href="/brat-green-generator/" className="hp-link font-bold text-lg">brat green generator</Link>
              <Link href="/brat-black-generator/" className="hp-link font-bold text-lg">black brat generator</Link>
            </div>
          </div>
        </div>
      </section>

      {/* ── SECTION 3: BRAT MYTHS VS REALITY ── */}
      <section className="bg-zinc-50 py-24 px-4 overflow-hidden border-b-2 border-black/5">
        <div className="max-w-[1200px] mx-auto flex gap-12 group">
          <div className="w-12 flex-shrink-0 flex items-start pt-2 hidden md:block">
            <span className="text-[12px] font-black uppercase tracking-[0.5em] [writing-mode:vertical-lr] rotate-180 opacity-50 group-hover:opacity-100 transition-all">Facts</span>
          </div>
          <div className="flex-1">
            <h2 className="text-4xl sm:text-7xl font-black italic uppercase tracking-tighter mb-12 leading-none">Brat Aesthetic - Myths vs Reality</h2>
            <div className="overflow-x-auto w-full mb-12 border-4 border-black">
              <table className="w-full text-left min-w-[600px] border-collapse bg-white">
                <thead>
                  <tr className="bg-black text-white">
                    <th className="p-6 text-xl font-black italic uppercase tracking-tighter w-1/2 border-r-2 border-white/20">Myth</th>
                    <th className="p-6 text-xl font-black italic uppercase tracking-tighter w-1/2">Reality</th>
                  </tr>
                </thead>
                <tbody className="text-[17px] hp-body-text">
                  <tr className="border-b-2 border-black/10">
                    <td className="p-6 border-r-2 border-black/10 opacity-70">You need Photoshop to make brat images</td>
                    <td className="p-6 font-medium text-black">Any browser works - no software needed</td>
                  </tr>
                  <tr className="border-b-2 border-black/10 bg-black/5">
                    <td className="p-6 border-r-2 border-black/10 opacity-70">Brat green is neon lime</td>
                    <td className="p-6 font-medium text-black">Real brat green is #89CC04 - darker and more muted</td>
                  </tr>
                  <tr className="border-b-2 border-black/10">
                    <td className="p-6 border-r-2 border-black/10 opacity-70">More text looks better</td>
                    <td className="p-6 font-medium text-black">1 to 4 words maximum - less is always more</td>
                  </tr>
                  <tr className="border-b-2 border-black/10 bg-black/5">
                    <td className="p-6 border-r-2 border-black/10 opacity-70">It needs to look polished</td>
                    <td className="p-6 font-medium text-black">Slightly rough and lo-fi is the whole point</td>
                  </tr>
                  <tr className="border-b-2 border-black/10">
                    <td className="p-6 border-r-2 border-black/10 opacity-70">You need a design background</td>
                    <td className="p-6 font-medium text-black">If you can type, you can make a brat image</td>
                  </tr>
                  <tr>
                    <td className="p-6 border-r-2 border-black/10 opacity-70 bg-black/5">Brat is only for Charli XCX fans</td>
                    <td className="p-6 font-medium text-black bg-black/5">Anyone using TikTok or Instagram can use it</td>
                  </tr>
                </tbody>
              </table>
            </div>
            <p className="hp-body-text text-[18px] font-bold italic leading-relaxed m-0 border-l-4 border-[#89CC04] pl-6 max-w-3xl">
              The brat aesthetic works because it breaks design rules on purpose. That is why it takes 30 seconds to make and still looks intentional.
            </p>
          </div>
        </div>
      </section>

      {/* ── SECTION 4: HOW CREATORS ACTUALLY USE THIS TOOL ── */}
      <section className="bg-white py-24 px-4 overflow-hidden border-b-2 border-black/5">
        <div className="max-w-[1200px] mx-auto flex gap-12 group">
          <div className="w-12 flex-shrink-0 flex items-start pt-2 hidden md:block">
            <span className="text-[12px] font-black uppercase tracking-[0.5em] [writing-mode:vertical-lr] rotate-180 opacity-50 group-hover:opacity-100 transition-all">Workflow</span>
          </div>
          <div className="flex-1">
            <h2 className="text-4xl sm:text-7xl font-black italic uppercase tracking-tighter mb-12 leading-none">How Creators Actually Use This Tool</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
              <div className="space-y-6">
                <div>
                  <h3 className="text-2xl font-black italic uppercase tracking-tighter mb-3 border-l-4 border-black pl-6">Profile Picture Batch</h3>
                  <p className="hp-body-text text-[17px] opacity-80 leading-relaxed m-0">Set your color to match your vibe. Type your name. Download the 1:1 square PNG. Upload to TikTok, Instagram, and Twitter. Takes under 2 minutes total.</p>
                </div>
                <div>
                  <h3 className="text-2xl font-black italic uppercase tracking-tighter mb-3 border-l-4 border-black pl-6">TikTok Content Calendar</h3>
                  <p className="hp-body-text text-[17px] opacity-80 leading-relaxed m-0">Lock your color and canvas. Change only the text for new ideas. Download 5 to 10 variants back to back. Schedule across the week. Consistent aesthetic, minimal effort - the{" "}
                    <Link href="/brat-text-generator/" className="hp-link">
                      brat text generator
                    </Link>{" "}
                    makes batch creation fast.</p>
                </div>
              </div>
              <div className="space-y-6">
                <div>
                  <h3 className="text-2xl font-black italic uppercase tracking-tighter mb-3 border-l-4 border-[#89CC04] pl-6">Reaction Memes</h3>
                  <p className="hp-body-text text-[17px] opacity-80 leading-relaxed m-0">Pick a black background. Write your reaction phrase. Download and paste into replies. &quot;not my problem&quot; in brat green hits differently than typed text. For more TikTok-specific ideas, see the{" "}
                    <Link href="/blog/brat-generator-for-tiktok/" className="hp-link">
                      brat generator for TikTok
                    </Link>{" "}
                    guide.</p>
                </div>
                <div>
                  <h3 className="text-2xl font-black italic uppercase tracking-tighter mb-3 border-l-4 border-black pl-6">Event Announcements</h3>
                  <p className="hp-body-text text-[17px] opacity-80 leading-relaxed m-0">Use the 16:9 ratio for Twitter banners. Brand colors as background. Event name in bold brat text. Instant attention-grabbing visual.</p>
                </div>
              </div>
            </div>
