    ...
    <main className="hp-root pb-24">
      ...
      <article className="px-4 pt-12 max-w-[720px] mx-auto">
        <div className="prose-container">
          ...
          <p className="hp-body-text mb-12 text-[17px] sm:text-[18px]">
            The clean girl aesthetic was popularized on TikTok around 2022 and 2023. Visually, it is defined by neutral tones like white, beige, and cream, along with slicked-back hair, no-makeup makeup, dewy skin, and minimal gold jewelry. The attitude is aspirational, disciplined, and quietly confident. Everything looks effortless, but the reality is that it requires significant effort: the right skincare routine, the right products, the right lighting. Clean girl lives on TikTok, Pinterest, and Instagram, where curated lifestyle content performs best. This is the key difference between the two: clean girl looks effortless but requires a lot of effort. Brat looks effortless and actually is effortless. One performs simplicity. The other genuinely does not care.
          </p>
