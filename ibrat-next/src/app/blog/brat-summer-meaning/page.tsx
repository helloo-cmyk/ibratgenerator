...
export const metadata = {
  ...
  description:
    "Brat summer means confidence, chaos, and zero apology. Learn where it started, what Charli XCX meant by it, and how the aesthetic spread worldwide.",
};
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    {
      "@type": "Question",
      name: "Is brat summer over?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "The peak moment was summer 2024 but the aesthetic and attitude have become part of mainstream culture. The minimalist green-and-text format is still widely used in 2026 for social media content, memes, and profile pictures.",
      },
    },
  ],
};

export default function BratSummerMeaningPage() {
  return (
    <main className="hp-root pb-24">
      ...
      <BlogHero
        ...
        imageSrc="/blog-images/meaning-hero.png"
        imageAlt="Brat summer meaning explanation graphic"
      />
      ...
      <article className="px-4 pt-12 max-w-[720px] mx-auto">
        <div className="prose-container">
          ...
          <FAQAccordion
            ...
            items={[
              {
                question: "What does brat summer mean?",
                answer: (
                  <p>
              ...
              {
                question: "Who started brat summer?",
                answer: (
                  <p>
              ...
              {
                question: "Is brat summer over?",
                answer: (
                  <p>
                    The peak moment was summer 2024 but the aesthetic and attitude
                    have become part of mainstream culture. The minimalist
                    green-and-text format is still widely used in 2026 for social
                    media content, memes, and profile pictures.
                  </p>
                ),
              },
            ]}
          ...
          <div className="mt-16 pt-8 border-t border-[var(--hp-border)] text-center text-sm text-[var(--hp-ink)] opacity-60">
